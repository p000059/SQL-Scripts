...
(
	...
	dtExclusaoOperacao	smalldatetime,
						constraint	fkInsumo_for_pkInsumo foreign key (fkInsumo) references bdestoque.dbo.tblInsumos (pkInsumo),
						constraint	fkCodigo_for_fkCodigo foreign key (fkCodigo) references bdestoque.dbo.tblCodigo	 (pkCodigo)
);
...
(
    ...
    dtInclusaoOperacao 	smalldatetime,
	dtExclusaoOperacao 	smalldatetime,
						constraint fkInsumo_for_pkInsumos			foreign key (fkInsumo)		references tblInsumos	  (pkInsumo),
...
(
    ...
    dtExclusaoOperacao	smalldatetime,
						...
						constraint fkInsumo_for_pkInsumo		  foreign key (fkInsumo)	 references tblInsumos	  (pkInsumo),
...
(
	...
	dtExclusaoOperacao 	smalldatetime,
						...
						constraint fkInsumo_for_pkInsumo1  foreign key (fkInsumo)  references tblInsumos (pkInsumo)
);
